...
public class Lactancias extends BaseProcTest {
	  String file1 = "resources/sicel/test/lactancias";
	...
	public static void main(String[] args) throws Exception {
	        BaseProcTest t = new Lactancias();
			t.deshacerTodos();
            t.MostrarAnimal("RC", "1111",true);
		}  
	...
	/**
	  ...
	  protected void finProceso(Session session) throws Exception {
		//con sexo
		  Animal an1 = AnimalDAO.findByRegistry("RC", "1111","HOLA","F");
		MostrarAnimal(an1);
	}
