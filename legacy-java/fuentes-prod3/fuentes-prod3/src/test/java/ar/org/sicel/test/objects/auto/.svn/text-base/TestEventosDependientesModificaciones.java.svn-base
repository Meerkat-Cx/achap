...
//
//public class TestEventosDependientesModificaciones extends TestCase {
//	
//	public void testEventosDependientes() throws Exception {
...
//		
//		
//		 //********** testear desde el primer info
//		 Iterator it = info.recolectarTodosEventosDependientes().iterator();
//		 EvtInfo info1_test = (EvtInfo) it.next();
//		 assertSame(info,info1_test);
//		 
//		 EvtInfo info11_test = (EvtInfo) it.next();
//		 assertSame(info11,info11_test);
//		 
//		 EvtReproduccion repr1_test = (EvtReproduccion) it.next();
//		 assertSame(repr1,repr1_test);
//		 
//		 EvtInfo infoCria_test = (EvtInfo) it.next();
//		 assertSame(infoCria,infoCria_test);
//		 assertFalse(it.hasNext());
//		 
//	 	 
//		 
//		 // ***** testear desde el alta ***
//		 Iterator it2 = alta.recolectarTodosEventosDependientes().iterator();
//		 assertSame(alta,it2.next());
//		 assertSame(serv1,it2.next());
//		 assertSame(info,it2.next());
//		 assertSame(info11,it2.next());
//		 assertSame(repr1,it2.next());
//		 assertSame(infoCria,it2.next());
