 ...
 * @author ala
 */
public class TestLactancia extends TestCase {
	...
	public void testTransicion() throws Exception {
        ...
        // TODO_OLD BUG edad max fertil de la hembra no pueden ser 35 años
        // TODO_OLD que hago?, no dejo que reciban eventos servicio o no dejo que
        // reciban
        // partos con crias vivas, ?
        // Esta ahora en el momento de crear el evento reproduccion, si la hembra
        // se pasa de la edad maxima fertil, rechaza el evento
        ...
        try {
            ...
            EvtReproduccionDAO.create(an1.getEstablecimiento(), an1, new Date(101, 2, 25),
                    new Date(100, 5, 18), false, false, crias, msgs,null, false,null,new Date()
                    );
            ...
            EvtOrdenieAnimalDAO.createSimple(an1, new Date(102, 0, 3), msgs)
                    .addMed("LE", 4.4f,an1).addMed("GR", 5.25f,an1);
