...
import ar.org.sicel.proc.v1.anmodif.types.STPais;
import ar.org.sicel.proc.v1.anmodif.types.STRaza;
import ar.org.sicel.proc.v1.anmodif.types.STSexo;
import ar.org.sicel.proc.v1.anmodif.types.STTReg;
...
/**
 * Identificación de un animal por alguno de sus registros. Se
 * debe indicar Tipo de registro (ver STTReg) y número
 * 
 * @version $Revision$ $Date$
 */
public abstract class TAnimReg implements java.io.Serializable {
     ...
     * Field _raza
     */
    private ar.org.sicel.proc.v1.anmodif.types.STRaza _raza;

    /**
     * Field _pais
     */
    private ar.org.sicel.proc.v1.anmodif.types.STPais _pais;

    /**
     * Field _sexo
     */
    private ar.org.sicel.proc.v1.anmodif.types.STSexo _sexo;

    /**
     * Field _tReg
     */
    private ar.org.sicel.proc.v1.anmodif.types.STTReg _tReg;
    ...
    } //-- ar.org.sicel.proc.v1.anmodif.TAnimReg()
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof TAnimReg) {
        
            TAnimReg temp = (TAnimReg)obj;
            if (this._raza != null) {
     ...
     */
    public ar.org.sicel.proc.v1.anmodif.types.STPais getPais()
    {
        return this._pais;
    } //-- ar.org.sicel.proc.v1.anmodif.types.STPais getPais() 
     ...
     */
    public ar.org.sicel.proc.v1.anmodif.types.STRaza getRaza()
    {
        return this._raza;
    } //-- ar.org.sicel.proc.v1.anmodif.types.STRaza getRaza() 
     ...
     */
    public ar.org.sicel.proc.v1.anmodif.types.STSexo getSexo()
    {
        return this._sexo;
    } //-- ar.org.sicel.proc.v1.anmodif.types.STSexo getSexo() 
     ...
     */
    public ar.org.sicel.proc.v1.anmodif.types.STTReg getTReg()
    {
        return this._tReg;
    } //-- ar.org.sicel.proc.v1.anmodif.types.STTReg getTReg() 
     ...
     */
    public void setPais(ar.org.sicel.proc.v1.anmodif.types.STPais pais)
    {
        java.lang.Object oldPais = this._pais;
        this._pais = pais;
        notifyPropertyChangeListeners("_pais", oldPais, this._pais);
    } //-- void setPais(ar.org.sicel.proc.v1.anmodif.types.STPais) 
     ...
     */
    public void setRaza(ar.org.sicel.proc.v1.anmodif.types.STRaza raza)
    {
        java.lang.Object oldRaza = this._raza;
        this._raza = raza;
        notifyPropertyChangeListeners("_raza", oldRaza, this._raza);
    } //-- void setRaza(ar.org.sicel.proc.v1.anmodif.types.STRaza) 
     ...
     */
    public void setSexo(ar.org.sicel.proc.v1.anmodif.types.STSexo sexo)
    {
        java.lang.Object oldSexo = this._sexo;
        this._sexo = sexo;
        notifyPropertyChangeListeners("_sexo", oldSexo, this._sexo);
    } //-- void setSexo(ar.org.sicel.proc.v1.anmodif.types.STSexo) 
     ...
     */
    public void setTReg(ar.org.sicel.proc.v1.anmodif.types.STTReg tReg)
    {
        java.lang.Object oldTReg = this._tReg;
        this._tReg = tReg;
        notifyPropertyChangeListeners("_tReg", oldTReg, this._tReg);
    } //-- void setTReg(ar.org.sicel.proc.v1.anmodif.types.STTReg) 
