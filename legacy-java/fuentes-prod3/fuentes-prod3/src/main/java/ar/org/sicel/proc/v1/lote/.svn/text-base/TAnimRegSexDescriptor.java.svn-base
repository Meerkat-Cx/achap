...
/**
 * Class TAnimRegSexDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TAnimRegSexDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TAnimRegSexDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TAnimRegSex target = (TAnimRegSex) object;
        ...
        //-- _pais
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(ar.org.sicel.proc.v1.lote.types.STPais.class, "_pais", "pais", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TAnimRegSex target = (TAnimRegSex) object;
                    target.setPais( (ar.org.sicel.proc.v1.lote.types.STPais) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(ar.org.sicel.proc.v1.lote.types.STPais.class, handler));
        desc.setImmutable(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _tReg
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(ar.org.sicel.proc.v1.lote.types.STTReg.class, "_tReg", "tReg", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TAnimRegSex target = (TAnimRegSex) object;
                    target.setTReg( (ar.org.sicel.proc.v1.lote.types.STTReg) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(ar.org.sicel.proc.v1.lote.types.STTReg.class, handler));
        desc.setImmutable(true);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        { //-- local scope
            ...
            typeValidator.setPattern("([A-Z]|[0-9])*");
            fieldValidator.setValidator(typeValidator);
        }
        desc.setValidator(fieldValidator);
    } //-- ar.org.sicel.proc.v1.lote.TAnimRegSexDescriptor()
    ...
    {
        return ar.org.sicel.proc.v1.lote.TAnimRegSex.class;
