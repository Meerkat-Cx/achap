...
/**
 * Class SistemaDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SistemaDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SistemaDescriptor() {
        ...
        desc.setValidator(fieldValidator);
    } //-- ar.org.sicel.proc.v1.lote.SistemaDescriptor()
    ...
    {
        return ar.org.sicel.proc.v1.lote.Sistema.class;
