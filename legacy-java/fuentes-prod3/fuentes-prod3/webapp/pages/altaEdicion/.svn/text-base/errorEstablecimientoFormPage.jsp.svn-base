...
<html:form action="/editarEstablecimientoValidate.do" method="post"> 
	...
	<tr> 
    	<td class=Titulo>
        	<font color=#529b28><img height=15 hspace=2 width=11 align=absMiddle>
            	&nbsp;Error durante el envío de correo electrónico en la edición de un tambo
			</font>
		</td>
...
<table width="90%" border="0" align="center" cellpadding="10" cellspacing="0">
	<tr> 
    	<td align="center">
    		<html:cancel styleClass="botones" onclick="document.forms[0].submit();">
