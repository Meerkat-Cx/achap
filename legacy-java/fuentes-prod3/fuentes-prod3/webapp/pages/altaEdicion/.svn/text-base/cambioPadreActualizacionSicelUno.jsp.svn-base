...
<html:form action="/actualizacionSicelUno.do" method="post" >
	...
	<TABLE width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
    	<TR> 
        	<TD class=Titulo><FONT color=#529b28><IMG height=15 hspace=2 
            	...
            	width=11 align=absMiddle>Cambio de Padre</FONT>
            </TD>
	...
	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		<TR>
			...
			<TD class="celdaInput">
                <html:select property="tipoRegOriPadre" styleClass="formfields" style="width:160px">
		...
		<TR>
			...
			<TD class="celdaInput">
                <html:text size="20" name="actualizacionSicelUnoForm" title="Número de registro" property="regOriPadre" />
            </TD>
		</TR>
		<TR>
			<TD class="celdaLabel">Raza: </TD>
			<TD class="celdaInput">
                <html:select property="razaPadre" styleClass="formfields" style="width:160px">
	...
	<script>
		function asignar(){
			document.forms[0].method.value = "asignarPadre";
			document.forms[0].submit();
    	}
    	function volver(){
			var mUrl="actualizacionSicelUno.do?method=volverCambioPadre";
