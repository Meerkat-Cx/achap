	...
	<table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
    	<tr>
        	<td class=Titulo>
            	...
            	Filtro para Cambios RP Masivos
            </td>
	...
	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		...
		<tr>
			<td class="celdaLabelSinAlign"  colSpan=2 align="center">
				El formato de la planilla debe ser RC | HBA | FNAC | RP.VIEJO | RP.NUEVO | TAMBO | PROP.ANIM
	...
	<c:if test="${!empty requestScope.errores}">
				<table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
			    	<tr>
			        	<td class=Titulo>
			            	<font color=#529b28><img height=15 hspace=2 width=11 align=absMiddle src="pages/assets/images/flecha_titulos3a.gif" >
			            	Errores Encontrados en la Carga
			            </td>
			            <td><div align=right></div></td>
			        </tr>
			        <tr>
	...
	function limitAttach() {
		...
		function validate() {
			...
			if (fotoRes.value == null || fotoRes.value == "") {
				alert("Se debe seleccionar un archivo para la carga");
				return false;
			}
			return true;
		}
