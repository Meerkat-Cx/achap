...
<div class="justify" id="displayEstancias">
<!-- TABLA CON LO QUE PARA NOSOTROS SON LAS ESTANCIAS, PARA LOS TAMBEROS SON LOS ESTABLECIMIENTOS-->
    <display:table name="listaEstancias" align="center"  class="its" id="item"  pagesize="8" requestURI="/editarPropietarioValidate.do?method=mostrarEstancias">

		<display:setProperty name="basic.msg.empty_list" >
		 	       <table width="80%" bgcolor="#eff3e3" class="bordeGris" cellSpacing="0" cellPadding="10" align="center" >
            		<TR>
            			<td class="TextoNegro">No hay Establecimientos Asociadas
            			</td>
            		</TR>
            	</table>
		</display:setProperty>
