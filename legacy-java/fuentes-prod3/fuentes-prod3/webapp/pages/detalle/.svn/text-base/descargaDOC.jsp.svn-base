...
<html:form action="/buscarCentroDeComputo.do" method="post">
		<!-- Titulo de la pagina -->
		 ...
		 <TABLE width="100$%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            ...
            width=11 align=absMiddle>Descarga&nbsp;de&nbsp;Documentos</FONT></TD>
...
<div class="justify">
    <display:table name="archivos" align="center" pagesize="20" id="item" sort="page" class="its" width="100%" requestURI="/buscarCentroDeComputo.do?method=ejecutar"  >
       <display:caption>
            	...
            	<tr> 
                	<td class=Titulo>
                		<font color=#529b28><img height=15 hspace=2 src="/web-1.0/pages/assets/images/flecha_titulos3a.gif" 
				            width=11 align=absMiddle>&nbsp;Documentos</font>
					</td>
					<td><div align=right></div></td>
				</tr>
				<tr> 
		...
		<display:column title="nombre" property="name" href="descargaDocumentacionAction.do?method=descargarArchivo" paramId="name" paramProperty="name"/>
