 ...
 <TABLE width="100$%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
   	...
   	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		<TR>
			...
			<TD class="celdaInput"><html:text size="45" name="reportesEcloForm" property="idProp" styleClass="Input10porc"/>
					
			 </TD>
		</TR>
		<TR>
			<TD class="celdaLabel">Nombre Propietario: </TD>
			<TD class="celdaInput"><html:text size="45" name="reportesEcloForm" property="nombreProp" styleClass="Input10porc"/>
			</TD>
		</TR>
</table>
    ...
    <display:table name="propietarios" align="center"  class="its" sort="list" id="item" pagesize="8" requestURI="/generarReportesEclo.do?method=buscarPropietario" >
		...
		<display:column align="left" title="Identificador" property="id" href="generarReportesEclo.do?method=seleccionarPropietario" paramId="id" paramProperty="id"/>
