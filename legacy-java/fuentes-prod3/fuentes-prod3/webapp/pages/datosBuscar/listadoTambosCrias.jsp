...
<html:form  action="/InformeTambosCriasAction"  enctype="multipart/form-data" onsubmit="return validate();">
		...
		<TABLE width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
			    <TR> 
					<TD class=Titulo><FONT color=#529b28><IMG height=15 hspace=2 src="pages/assets/images/flecha_titulos3a.gif" width=11 align=absMiddle>
						Informe de Tambos con Crías Inscriptas</FONT>
					</TD>
				</TR>
				<TR> 
    ...
    <table width="100%" bgcolor="#eff3e3" class="bordeGris" cellSpacing="0" cellPadding="10" align="center" >
		...
		<TR>
			<TD class="celdaLabel">[descargar informe] </TD>
			<TD  class="celdaLabelSinAlign" align="left"><a href="javascript:setMethod('descargarReporteXLS')"><img border="0" src="img/EXCEL.jpg" title="Descargar"/></a></TD>
...
<script language="JavaScript">
	function setMethod(valor,vale){
		...
		if(!esFechaValida(document.forms[0].fechaDesde))
				return;	
		...
		if(!esFechaValida(document.forms[0].fechaHasta))
				return;	
	...
	function esFechaValida(fecha){
		if (fecha != undefined && fecha.value != "" ){//verifica formato correcto
		    ...
		    switch(mes){
			  ...
			  if (f1<f2){
			     alert("Fecha introducida mayor al día actual");
			     return false;
			 }   
		   return true;
		 }
