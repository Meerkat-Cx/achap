...
<html:form action="/editarEstablecimientoValidate.do"  >
		<!-- Titulo de la pagina -->
		 <input type="hidden" name="method" value="buscarEclo">
		 
		 <html:hidden name="establecimientoForm" property="idEst" styleId="idEclo"/>
   	...
   	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		<TR>
			...
			<TD class="celdaInput">
                <html:text size="45" name="establecimientoForm" property="nombreContactoEclo" styleClass="Input10porc"/>
            </TD>
		</TR>
		...
		<TR>
			...
			<TD class="celdaInput">
                <html:text size="45" name="establecimientoForm" property="idEclo" styleClass="Input10porc"/>
            </TD>
		</TR>
</table>
		 ...
		 <table width="90%" border="0" align="center" cellpadding="10" cellspacing="0">
                      <tr> 
                        <td align="center">
					<td align="center">
					<td align="center"><input type="button" value="Aceptar" class="botones" onclick="setMethod('buscarEclo')"></td>				
				...
				<div class="justify">
    <display:table name="eclos" align="center"  class="its" sort="list" id="item" pagesize="8" requestURI="/editarEstablecimientoValidate.do?method=buscarEclo" >
        <display:caption>
            <table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            	<tr> 
                	<td class=Titulo>
                		<font color=#529b28><img height=15 hspace=2 src="/web-1.0/pages/assets/images/flecha_titulos3a.gif" 
				            width=11 align=absMiddle>&nbsp;Eclos Activas</font>
					</td>
        ...
        <display:column align="left" title="Identificador" property="id" href="editarEstablecimientoValidate.do?method=seleccionarEclo" paramId="id" paramProperty="id"/>
		...
		function volver() {
			...
			if (metodo == "update") {
				var idEclo = document.getElementById("idEclo").value;
				var mUrl = "editarEstablecimientoValidate.do?method=initmod&id="+idEclo;
			}
			else
