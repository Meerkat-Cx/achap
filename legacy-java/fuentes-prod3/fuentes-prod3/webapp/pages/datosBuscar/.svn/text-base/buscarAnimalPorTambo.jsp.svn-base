...
<html:form action="/buscarAnim.do" method="post" >
   	...
   	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		<TR>
			...
			<TD class="celdaInput">
                <html:text size="45" name="animalForm" property="tamboId" styleClass="Input10porc"/>
            </TD>
		</TR>
		<TR>
			<TD class="celdaLabel">Nombre Tambo: </TD>
			<TD class="celdaInput">
                <html:text size="45" name="animalForm" property="nombreEstablecimiento" styleClass="Input10porc"/>
            </TD>
		</TR>
		 ...
		 <table width="90%" border="0" align="center" cellpadding="10" cellspacing="0">
                      <tr> 
                        <td align="center">
					<td align="center">
					<td align="center"><input type="button" value="Buscar" class="botones" onclick="setMethod('buscarTambos')"></td>				
						<td align="center">
    ...
    <display:table name="listaTambos" align="center"  class="its" sort="list" id="item" pagesize="8" requestURI="/buscarAnim.do?method=buscarTambos" >
        <display:caption>
            <table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            	<tr> 
                	<td class=Titulo>
...
<display:column align="left" title="Identificador">        
		...
		function setMethod(valor){
			if(document.forms[0].elements["tamboId"]!=null){
				if (!isPosInteger(document.forms[0].elements["tamboId"].value)) {
		...
		var idElem = document.getElementById("tamboId");
		
		idElem.value = "";
		nomElem.value = "";
		
	}
	function ejecutar(idTambo){
		document.forms[0].tamboId.value = idTambo;
		document.forms[0].submit();
