...
<html:form action="/filtrarCalificacionAction.do" method="post" >
		<!-- Titulo de la pagina -->
		  ...
		  <input type="hidden" name="method" value="initBuscar">
		 ...
		 <html:hidden property="error" value="${requestScope.error}"/>	
	 	 <!-- html:javascript formName="filtroCalificacionForm"/-->
   	...
   	<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
		<TR>
			...
			<TD class="celdaInput">
                <html:text size="45" name="filtroCalificacionForm" property="estanciaId" styleClass="Input10porc"/>
            </TD>
		</TR>
		<TR>
			<TD class="celdaLabel">Nombre Establecimiento: </TD>
			<TD class="celdaInput">
                <html:text size="45" name="filtroCalificacionForm" property="estanciaNombre" styleClass="Input100porc"/>
            </TD>
		</TR>
</table>
...
<table width="90%" border="0" align="center" cellpadding="10" cellspacing="0">
	<tr> 
		...
		<td align="center"><input type="button" value="Cancelar" class="botones" onclick="volver()"></td>
				...
				<div class="justify">
    <display:table name="estancias" align="center"  class="its" sort="list" id="item" pagesize="8" requestURI="/filtrarCalificacionAction.do?method=buscarEstancia" >
        <display:caption>
            <table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            	<tr> 
                	<td class=Titulo>
		...
		function volver() {
			...
			var mUrl = "filtrarCalificacionAction.do?method=initBuscar";
			window.location.href = mUrl;
		}
		
		function setMethod(valor){	
		if(document.forms[0].elements["estanciaId"]!=null){
				if (!isPosInteger(document.forms[0].elements["estanciaId"].value)) {
    	...
    	function ejecutar(idEstancia){
		document.forms[0].estanciaId.value = idEstancia;
		document.forms[0].submit();
