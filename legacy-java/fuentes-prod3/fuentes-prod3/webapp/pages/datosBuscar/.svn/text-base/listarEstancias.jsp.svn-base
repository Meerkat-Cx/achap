...
<html:form action="/buscarEstancia.do" method="post" focus="idEst" >
		<!-- Titulo de la pagina -->
		 ...
		 <TABLE width="100$%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            ...
            width=11 align=absMiddle>B&uacute;squeda de Establecimientos</FONT></TD>
...
<table width="100%" class="bordeGris" cellSpacing="0" cellPadding="2" align="center" >
	...
	<TR>		
		...
		<TD class="celdaInputBusqueda"><html:text size="45" name="busquedaEstanciaForm" property="idEst" styleClass="Input100porc"/></TD>
	</TR>

	<TR>		
		<TD class="celdaLabelBusqueda">Nombre:</TD>
		<TD class="celdaInputBusqueda"><html:text size="45" name="busquedaEstanciaForm" property="nombre" styleClass="Input100porc"/></TD>
	</TR>

	<TR>
		<tD class="celdaLabelBusqueda">Nombre de Propietario:</TD>
		<TD class="celdaInputBusqueda"><html:text size="45" name="busquedaEstanciaForm" property="nombrePropietario"  styleClass="Input100porc"/></TD>
	</TR>
	
	<c:if test="${busquedaEstanciaForm.rolAdmin == busquedaEstanciaForm.rol}">	
	<TR>
		<TD class="celdaLabelBusqueda">Identificador Eclo:</TD>
		<TD class="celdaInputBusqueda"><html:text size="45" name="busquedaEstanciaForm" property="idEclo"  styleClass="Input100porc"/></TD>
	</TR>
	</c:if>
...
<div class="justify">
    <display:table name="estanciaData" align="center" pagesize="10" id="item" sort="page" class="its" width="100%" requestURI="/buscarEstancia.do?method=ejecutar"  >
       <display:caption>
            <table width="100%" cellPadding=2 cellSpacing=2 bgcolor="#eff3e3">
            	<tr> 
                	<td class=Titulo>
		...
		<display:column align="left" title="id">
	        <a align="right" href="javascript:MM_openBrWindow('buscarEstancia.do?method=initView&id=<bean:write name="item" property="id" />','','scrollbars=yes,resizable=yes,width=900,height=350,top=100,left=100')">
	...
	function limpiar() {		
		...
		var nomRegionalElem = document.forms[0].elements["nombrePropietario"];
		idE.value = "";
		nomElem.value = "";
		idElem.value = "";
