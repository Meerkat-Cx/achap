...
function expandir_formulario(){
		if (document.entidadRegionalForm.ubicaciones.value == "0"){
			xDisplay('ubicacion1', 'none')			
	 	}
		if (document.entidadRegionalForm.ubicaciones.value == "1"){
			xDisplay('ubicacion1', 'block')
		}
}